...
I think I found a mistake in the material, as the instructions set up a "sources" directory as "root", yet later direct you to unpack files as "lfs" user, which doesn't have access, and so won't work.
